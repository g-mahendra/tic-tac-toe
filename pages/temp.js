    ...
    <div>
      ...
      <main className={styles.main}>
        <div className={styles.heroContent}>
          ...
          <h3 style={{
            fontWeight: 'lighter'
          }}>This is a simple but multiplayer online Tic-tac-toe game that you can play from comfort of your home with any of your firends just by sending a game code</h3>
          <button id={styles.playButton}>Lets Play</button>
        </div>
        <div>
          <svg className={styles.heroSvg} viewBox="0 0 960 1080" fill="none" xmlns="http://www.w3.org/2000/svg">
